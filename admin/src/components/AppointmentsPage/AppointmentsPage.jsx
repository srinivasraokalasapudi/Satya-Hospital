...
import { formatDate, statusClasses } from "../../utils/format";
...
export default function AppointmentsPage() {
  ...
  async function handleDelete(id) {
    ...
    try {
      ...
      alert(err?.response?.data?.error || "Could not delete appointment.");
    }
  }
    ...
    <div className="min-h-screen font-serif bg-emerald-50 p-3 sm:p-4 md:p-6 lg:p-8">
      <div className="max-w-[1400px] mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-xl sm:text-2xl font-semibold text-emerald-800">Doctor Appointments</h1>
                ...
                <div key={a._id} className="bg-white rounded-2xl shadow-sm border border-emerald-100 overflow-hidden">
                  <div className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className="text-sm text-emerald-600">Dr. {a.doctorname} • {a.specialization}</p>
                  ...
                  {expanded && (
                    <div className="px-4 pb-4 pt-0 border-t border-emerald-50 text-sm text-gray-700 space-y-2">
                      <p><span className="font-medium text-emerald-800">Problem: </span>{a.problem}</p>
                      {a.aiBrief && (
